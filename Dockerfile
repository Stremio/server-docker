...
RUN wget https://repo.jellyfin.org/archive/ffmpeg/debian/4.4.1-4/jellyfin-ffmpeg_4.4.1-4-buster_amd64.deb
RUN apt -y install ./jellyfin-ffmpeg_4.4.1-4-buster_amd64.deb
RUN rm jellyfin-ffmpeg_4.4.1-4-buster_amd64.deb
